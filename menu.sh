...
sleep 2
echo -e ""
echo -e "                PUBLIC IP :$GETIP"   
echo -e "                     HOST :$GETHOST"     
echo -e "                       OS :Ubuntu $VERSION_ID"
echo -e ""
...
echo -e "* cv2r        : Memperbarui Sertifikat Akun V2RAY [ Apabila Ganti Domain]"
echo -e ""
echo -e "=============================-VLESS-==========================="
echo -e "* addvl       : Membuat Akun V2RAY Vless Websocket"
echo -e "* delvl       : Menghapus Akun V2RAY Vless Websocket"
echo -e "* renewvl     : Memperpanjang Masa Aktif Akun Vless"
echo -e "* cekws       : Cek User Login V2RAY"
echo -e ""
echo -e "=============================-Trojan-=========================="
