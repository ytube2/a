...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/ytube2/a/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/ytube2/a/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{ME.crt,HABLE.key,ca.crt,ta.key} clientconfig/
cd clientconfig
