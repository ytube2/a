...
echo -e "${Info} Wireguard VPS AutoScript by ME"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/sfeduku/sco/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/sfeduku/sco/main/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/sfeduku/sco/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/sfeduku/sco/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/sfeduku/sco/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
